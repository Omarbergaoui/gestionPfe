    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        .csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(req ->
                        req.requestMatchers("/Authentication/Login","/Authentication/refresh-token","/Authentication/SendMail","/Authentication/Verify/**","/Authentication/Change-Password/**","/Authentication/activate")
                                .permitAll()
